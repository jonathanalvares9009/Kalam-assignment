...
const Hero = () => {
  return (
    <section className="flex flex-col gap-10 py-8 lg:items-center pb-16 relative">
        ...
        <Image src="/work.webp" height={300} width={400} alt="Hero" className="w-full lg:w-3/5" unoptimized={true} />
    </section>
  )
}
