...
const ShareModal = ({ setClose }: ShareModalProps) => {
  ...
  return (
    ...
    >
      <div
        className="flex flex-col fixed bg-white rounded-lg p-8 gap-6 text-center w-4/5 lg:w-2/5 sm:text-left"
        onClick={(e) => {
          e.stopPropagation();
        }}
      >
        <Image
          ...
          height={300}
          alt="Shot to share"
          className="absolute left-1/2 transform -translate-x-1/2 top-negative-40 rounded-xl"
        />
        <h1 className="text-blue-100 font-bold text-2xl pt-52 text-center">
          Share this with your social Community
        </h1>
        <div className="flex gap-4 justify-center">
          <a
            href="https://dribbble.com/shots/21514221-Wemsc-Music-Streaming-Desktop-App-Dark-Mode#"
            className="bg-pink-50 w-16 h-16 flex justify-center items-center rounded-full"
          >
            <Image
              src="/pinterest.svg"
              width={40}
          ...
          <a
            href="https://dribbble.com/shots/21514221-Wemsc-Music-Streaming-Desktop-App-Dark-Mode#"
            className="bg-blue-50 w-16 h-16 flex justify-center items-center rounded-full"
          >
            <Image
              src="/twitter.svg"
              width={40}
        ...
        <div className="flex w-full justify-between py-2 px-4 bg-gray-100 rounded-xl">
          <p className="font-light truncate" id="text-to-copy">
            https://dribbble.com/shots/21514221-Wemsc-Music-Streaming-Desktop-App-Dark-Mode?utm_source=Clipboard_Shot&utm_campaign=nailulizah&utm_content=Wemsc%20-%20Music%20Streaming%20Desktop%20App%20(Dark%20Mode)&utm_medium=Social_Share&utm_source=Clipboard_Shot&utm_campaign=nailulizah&utm_content=Wemsc%20-%20Music%20Streaming%20Desktop%20App%20(Dark%20Mode)&utm_medium=Social_Share
          </p>
          <p className="font-normal cursor-pointer" onClick={copyToClipboard}>
            Copy
          </p>
        </div>
        <Image
          src="/close_without_bg.svg"
          width={20}
          height={20}
          alt="Close"
