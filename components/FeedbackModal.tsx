  ...
  return (
    <section className="flex flex-col gap-20 sticky top-0 right-0 px-4 h-screen bg-white border border-t-transparent border-b-transparent transition transform duration-[800ms] ease-in-out delay-0 border-l-gray-300 w-4/5 md:w-1/2 lg:w-1/4">
      ...
      <div className="flex flex-col gap-4 items-center">
        <Image
          src="/comments-signup-avatars.webp"
          width={100}
          height={100}
          alt="Profile"
        ...
        <p className="text-center text-sm font-medium text-gray-10">
          Looking to share your feedback and start the conversation?
        </p>
        <button className="bg-black rounded-full w-3/5 py-1 text-white text-md hidden sm:block">
          Sign up to Dribble
        </button>
      </div>
      <button
        className="absolute h-8 w-8 left-[-16px] top-2 bg-white border border-gray-300 rounded-full"
